...
class EvForm extends Component {
 ...
 _handleDatePicked = (value) => {
   this.props.evUpdate({ prop: 'eventDate', value:moment(value).format('YYYY/MM/DD HH:mm:ss')})
    ...
    <View>
      <CardSection>
        <Input
          ...
          onChangeText={value => this.props.evUpdate({ prop: 'title', value })}
        />
      </CardSection>
      ...
      <Input
        ...
        onChangeText={value => this.props.evUpdate({ prop: 'description', value })}
      />
      </CardSection>
      <CardSection >
